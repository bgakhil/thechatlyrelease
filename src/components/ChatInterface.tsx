...
const ChatInterface = ({ interests, onDisconnect, onNewChat, onlineCount }: ChatInterfaceProps) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-background">
      {/* Header */}
      <Card className="m-4 p-4 bg-card/80 backdrop-blur-sm border-0 shadow-lg">
      ...
      {/* Messages */}
      <Card className="flex-1 m-4 mt-0 bg-card/80 backdrop-blur-sm border-0 shadow-lg flex flex-col">
